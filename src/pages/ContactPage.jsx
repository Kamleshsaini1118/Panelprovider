...
//        {/* section second */}
//         <div className="flex flex-col items-start justify-center text-center my-16 pl-72">
//           <h2 className="text-white text-4xl font-bold ">Get in touch with us</h2>

//           <div className="flex items-center bg-gradient-to-br from-[#0b172595] to-[#1d2434bb] shadow-lg rounded-2xl w-full max-w-3xl border-[1px] border-purple-400 hover:border-yellow-400 px-8 py-9 mt-8">
//             <div className="mr-4">
//               <svg
