...
const siteList = [
  {
    name: "Mydiamondexch.com",
    img: "/1.jpg",
    link: "https://wa.link/qnz6f1",
    rate: "Monthly rent 15k, unlimited coins",
  },
  {
    name: "Trubet365.in",
    img: "/2.jpg",
    link: "https://wa.link/qnz6f1",
    rate: "Monthly rent 18k, unlimited coins",
  },
  {
    name: "Betsbhai9.co",
    img: "/2.jpg",
    link: "https://wa.link/qnz6f1",
    rate: "Monthly rent 12k, unlimited coins",
  },
  {
    name: "Skysport6.com",
    img: "/2.jpg",
    link: "https://wa.link/qnz6f1",
    rate: "Monthly rent 14k, unlimited coins",
  },
  {
    name: "D247.vip",
    img: "/2.jpg",
  ...
  },
  {
    ...
    img: "/2.jpg",
    link: "https://wa.link/qnz6f1",
    rate: "Monthly rent 20k, unlimited coins",
  },
];
...
const SiteCard = memo(({ site }) => (
  <div
    className="flex items-center bg-transparent hover:bg-gradient-to-br from-[#0b172595] to-[#1d2434bb] 
  ...
  >
    ...
    <Link
      to={site.link}
      className="ml-auto bg-[#FFB90C] text-black text-sm md:text-lg px-6 py-2 md:px-24 md:py-3 rounded-full hover:bg-[#d4ba77] hover:text-black transition"
    >
      Create
    </Link>
  </div>
    ...
    <div className="bg-[#0a1128] h-auto">
      <section className="container mx-auto p-4">
        ...
        <div className="flex flex-col items-center justify-center mt-20 md:my-24 gap-4">
          ...
          <span className="flex text-base md:text-lg gap-x-2 font-medium text-white">
            HOME <FaChevronRight size={18} className="mt-1" /> SHARING SITES
            LIST
          </span>
        </div>
