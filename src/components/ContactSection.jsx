    ...
    <section className="bg-gradient-to-br from-[#0b1725] via-[#1d2434] to-[#130738] py-16 px-4 ">
      <div className="container mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8">
          {[
            { icon: <FaYoutube size={22} />, name: "YouTube", link: "https://www.youtube.com/" },
            { icon: <FaInstagram size={22} />, name: "Instagram", link: "https://www.instagram.com/" },
            { icon: <FaTelegramPlane size={22} />, name: "Telegram", link: "https://web.telegram.org/" },
          ].map((item, index) => (
            <button
              key={index}
            ...
            >
              <a
                className="flex items-center bg-[#080e26] text-white text-lg px-20 py-3 rounded-full shadow-lg font-medium hover:bg-white hover:text-black transition w-full h-full gap-4"
                href={item.link}
                target="_blank"
                rel="noopener noreferrer"
              >
